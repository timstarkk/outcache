                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainerMiddle">
                                <tr>
                                    <td valign="top" class="bodyContent" mc:edit="body_content">
                                        <h3>Hey {{name}},</h3>
                                        <h2><strong>Your recent rental has been approved!</strong></h2>
                                        <p>Please logon to your Outcache profile to view details of the approved rental and to coordinate payment. Thanks!<br /><br /></p>
                                    </td>
                                </tr>
                            </table>
                            <!-- // END BODY -->
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateContainerMiddle">
                                <tr>
                                    <td valign="top" class="bodyContentCenter" mc:edit="body_content_centered">
                                        <a class="blue-btn" href="https://www.outcache.com/login"><strong>Check Your Rentals</strong></a>
                                    </td>
                                </tr>
                            </table>
                            <!-- // END BODY -->
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" id="templateContainerFooter">
                                <tr>
                                    <td valign="top" width="100%" mc:edit="footer_unsubscribe">
                                        <h6 style="text-align:center;margin-top: 9px;">Outcache</h6>
                                        <h6 style="text-align:center;">Austin, TX</h6>
                                        <h6 style="text-align:center;">info@outcache.com</h6>
                                        <h6 style="text-align:center;margin-top: 7px;"><a href="https://www.outcache.com">unsubscribe</a></h6>
                                    </td>
                                </tr>
                            </table>
                        </td>
